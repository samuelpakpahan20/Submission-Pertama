...
## Data Understanding
Dataset yang saya gunakan adalah [Automobile Dataset](https://www.kaggle.com/toramky/automobile-dataset). Untuk informasi lanjut tentang dataset ini dapat dibaca pada dokumentasi [ini](https://archive.ics.uci.edu/ml/datasets/automobile).
